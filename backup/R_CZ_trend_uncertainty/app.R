      ...
      h4(div(
        ...
        HTML(paste0(
         ...
         <a href='https://onemocneni-aktualne.mzcr.cz/api/v2/covid-19'>official JSONs by MZČR & ÚZIS</a> (last change at source: ", textOutput("data_sourced", inline = TRUE),
          ...
          (mainly due to poor testing at weekends). Analysis based on raw data and uncertain SI is available <a href="https://netique.shinyapps.io/R_CZ_uncertainty/">here</a>, analysis with serial interval distributions estimated directly from infector-infectee pairs data using Metropolis-Hastings Markov chain Monte Carlo is available <a href="https://netique.shinyapps.io/R_CZ_trend_MCMC/">here</a> (trend only).'
        ))
      )),
      em(
        HTML(
