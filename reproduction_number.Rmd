...
# apify fail - no uptodate tested numbers
...
Limit dataset from outbreak beginning to last complete day (usually, *fully closed* data are given around 9 AM *the day after*). Prepare incidence (day-to-day) data for further use. Please, **check the validity by hand**.
